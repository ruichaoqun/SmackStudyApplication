...
import com.smack.administrator.smackstudyapplication.util.sys.AppUtils;
...
public class NotifierManager {
     ...
     * @param message
     */
    public synchronized void notify(CustomChatMessage message) {
...
//        }
        ...
        if (!AppUtils.isAppForeground(appContext)) {
            Log.w(TAG, "app is running in background");
            notificationNum++;
            fromUsers.add(message.getSendUserName());
            handleMessage(message);
        }
    }

    public synchronized void notify(List<CustomChatMessage> messages) {
...
//        }
     ...
     * @param message
     */
    protected void handleMessage(CustomChatMessage message) {
        try {
...
//            }
     ...
     */
    public void vibrateAndPlayTone(CustomChatMessage message) {
//        if (message != null) {
//            if (EaseCommonUtils.isSilentMessage(message)) {
//                return;
//            }
...
//            }
    ...
    public interface EaseNotificationInfoProvider {
         ...
         */
        String getDisplayedText(CustomChatMessage message);
         ...
         * @return null-will use the default text
         */
        String getLatestText(CustomChatMessage message, int fromUsersNum, int messageNum);
         ...
         * @return null- will use the default text
         */
        String getTitle(CustomChatMessage message);
         ...
         */
        int getSmallIcon(CustomChatMessage message);
         ...
         */
        Intent getLaunchIntent(CustomChatMessage message);
    }
}
