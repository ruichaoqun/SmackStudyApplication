...
import com.smack.administrator.smackstudyapplication.widget.imageview.CheckedImageButton;
...
public class EmoticonPickerView extends LinearLayout implements IEmoticonCategoryChanged {
    ...
    private void init(Context context) {
        ...
        inflater.inflate(R.layout.xmpp_emoji_layout, this);
    }
...
//            LogUtil.i("sticker", "listener is null");
    ...
    private void loadStickers() {
        ...
        btn.setNormalImageId(R.mipmap.xmpp_emoji_icon_inactive);
        btn.setCheckedImageId(R.mipmap.xmpp_emoji_icon);
