...
//        UserPreferences.setStatusConfig(userConfig);
    ...
    private static StatusBarNotificationConfig loadStatusBarNotificationConfig() {
        ...
        // 点击通知需要跳转到的界面
        config.notificationEntrance = Main2Activity.class;
        config.notificationSmallIconId = R.mipmap.ic_launcher;
        config.notificationColor = XmppConnection.getInstance().getAppContext().getResources().getColor(R.color.color_blue_3a9efb);
        // 通知铃声的uri字符串
        config.notificationSound = "android.resource://com.smack.administrator.smackstudyapplication/raw/msg";
...
//            return MessageRevokeTip.getRevokeTipContent(item, revokeAccount);
    ...
    private static class DemoCache {
    }
}
