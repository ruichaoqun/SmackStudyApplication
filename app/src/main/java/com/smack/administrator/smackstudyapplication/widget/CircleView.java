package com.smack.administrator.smackstudyapplication.widget;
...
public class CircleView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            borderColor = array.getColor(R.styleable.CircleView_ease_border_color, borderColor);
            borderWidth = array.getDimensionPixelOffset(R.styleable.CircleView_ease_border_width, borderWidth);
            pressAlpha = array.getInteger(R.styleable.CircleView_ease_press_alpha, pressAlpha);
            pressColor = array.getColor(R.styleable.CircleView_ease_press_color, pressColor);
            radius = array.getDimensionPixelOffset(R.styleable.CircleView_ease_radius, radius);
            shapeType = array.getInteger(R.styleable.CircleView_ease_shape_type, shapeType);
            array.recycle();
        }
