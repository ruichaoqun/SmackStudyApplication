...
//    };
    ...
    private class MessageLoader implements BaseFetchLoadAdapter.RequestLoadMoreListener, BaseFetchLoadAdapter.RequestFetchMoreListener {
        ...
        public MessageLoader(CustomChatMessage anchor, boolean remote) {
            this.anchor = anchor;
            this.remote = remote;
            if (remote) {
                loadFromRemote();
    ...
    public void updateReceipt(final List<CustomChatMessage> messages) {
    ...
    private boolean receiveReceiptCheck(final CustomChatMessage msg) {
    ...
    public void sendReceipt() {
        ...
        CustomChatMessage message = getLastReceivedMessage();
    ...
    private boolean sendReceiptCheck(final CustomChatMessage msg) {
    ...
    private CustomChatMessage buildForwardRobotMessage(final String sessionId, SessionTypeEnum sessionTypeEnum) {
