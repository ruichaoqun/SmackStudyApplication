...
import com.smack.administrator.smackstudyapplication.widget.recyclerview.holder.RecyclerViewHolder;
...
//            NIMClient.getService(MsgService.class).downloadAttachment(message, true);
    ...
    /// -- 以下是基类实现代码
    @Override
    public void convert(BaseViewHolder holder, CustomChatMessage data, int position, boolean isScrolling) {
