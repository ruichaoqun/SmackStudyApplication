package com.smack.administrator.smackstudyapplication.widget.imageview;
...
public class HeadImageView extends CircleImageView {
    ...
    public static final int DEFAULT_AVATAR_THUMB_SIZE = (int) XmppConnection.getInstance().getAppContext().getResources().getDimension(R.dimen.avatar_max_size);
    public static final int DEFAULT_AVATAR_NOTIFICATION_ICON_SIZE = (int) XmppConnection.getInstance().getAppContext().getResources().getDimension(R.dimen.avatar_notification_size);
    private static final int DEFAULT_AVATAR_RES_ID = R.mipmap.ease_default_avatar;
    ...
    public void loadBuddyAvatar(String account) {
        final ChatUser userInfo = XmppConnection.getInstance().getUserInfo(account);
     ...
     * @param message 消息
     */
    public void loadBuddyAvatar(CustomChatMessage message) {
        String account = message.getSendUserName();
